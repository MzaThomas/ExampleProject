...
import { CButton, CCard, CCardBody, CCardHeader, CCol, CImg, CRow } from "@coreui/react";
const Welcome = () => {
      ...
      <CCard>
        ...
        <CCardBody>
          ...
          <div style={{ display: "flex", marginTop: "20px" }}>
            {files.map((a) => (
              <>
                <li style={{ marginTop: "5px" }} key={a.name}>{a.name}</li>    <CButton className="btn-danger" style={{ marginLeft: "20px" }} onClick={removeFile}>Delete File</CButton>
              </>
            ))}
          </div>
